...
const Experience = () => {
  ...
  const experienceData = [
    {
      name: "Graduated bootcamp",
      position: " DSPMU Ranchi",
      duration: "2023-2027",
      description:
    ...
    },
    {
      ...
      position: "SYSROOT SOLUTION PVT LTD",
      duration: "2023-2024",
      description:
    ...
    },
    {
      ...
      position: "Sheryians Coding School",
      duration: "2024",
      description:
  ...
  return (
    <>
      <div className="exprience relative">
        <h1 className="font-[600] pt-6 text-3xl  lg:pt-0 lg:pb-12 text-center " >My Experience</h1>

        <div className="experience_wrapper_box flex flex-col  gap-5">
          {experienceData.map((val) => {
            x++;
            return (
              <div className={`exprience_wrap_box exprience_wrap_box${x} mt-12 px-5 lg:px-[4.3rem]  flex items-center gap-8 relative w-full`}>
                
                <div className="exprience_icon bg_shadow w-14 h-14 rounded-full bg-white flex items-center justify-center "> {val.svg}</div>
                <div className="exprience_content border border-black/5 bg-[#F3F4F6] rounded-lg p-8 lg:w-[37.3rem] ">
